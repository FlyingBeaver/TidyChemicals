...
Storage = class Storage extends Chemical {
  ...
  static open_with_path(path_to_node) {
    var children_data, full_path, i, j, last_node, last_node_id, node_children, node_id_to_open, node_to_open, ref;
    full_path = path_to_node.full_path;
    children_data = path_to_node.children;
    for (i = j = 0, ref = full_path.length - 2; (0 <= ref ? j <= ref : j >= ref); i = 0 <= ref ? ++j : --j) {
