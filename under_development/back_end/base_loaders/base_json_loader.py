import json
from base_app.models import Chemical, StoragePlace, QuantityUnit, Element
...
def load_base():
    ...
    with open(".json", "rt", encoding="utf-8") as file:
        raw_json = file.read()
    all_records = json.loads(raw_json)
    for record in all_records:
        elements_dict = record.pop("elements_dict")
