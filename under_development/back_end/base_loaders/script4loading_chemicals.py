...
larysa_hrybalova = find_user_by_name("LarysaHrybalova")
...
class StructureLoader:
    ...
    def create_summary(self):
        ...
        return fields_dict
        # Что есть что в словаре fields_dict
        #
        # structure представляет из себя словарь, 
        # который содержит ключи inchi и aq.
        # aq -- число акватации
        # inchi -- inchi вещества
        # aq сам по себе представляет из себя либо
        # целое число, либо кортеж из двух 
